...
const MOCK: Notification[] = [
  {
    ...
    message: "Bitcoin hit your target price of $45,000",
  ...
  },
  {
    ...
    message: "iOS login from a new device at 14:32 UTC",
  ...
  },
  {
    ...
    message: "0.01 BTC sent to bc1q…5x3y",
  ...
  },
  {
    ...
    type: "system",
    title: "App Updated",
    message: "CryptoVault v1.0.0 — new features available",
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const apiNotes: Notification[] = (res.data ?? res ?? []).map(
          (n: any) => ({
            id: String(n.id),
