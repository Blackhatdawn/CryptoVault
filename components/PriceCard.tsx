...
// Memoized to prevent unnecessary re-renders in lists when unrelated price updates occur.
// This is critical for performance on screens with live-streaming WebSocket updates.
